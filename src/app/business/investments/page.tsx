    ...
    <MainLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-3xl font-bold gradient-text">Investment Management</h1>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          ...
          <TabsContent value="overview" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <StatsCard
                ...
                change={{ value: `+${fundingSummary.shareAppreciation}%`, positive: true }}
              />
              <StatsCard
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card className="glass-card hover-glow">
                <CardHeader>
                  <CardTitle className="text-md font-medium">Ownership Distribution</CardTitle>
                </CardHeader>
                  ...
                  <div style={{ height: 300, width: '100%' }}>
                    <ResponsiveContainer width="100%" height="100%">
                      <PieChart>
                        ...
                        >
                          {chartData.ownershipPie.map((entry, index) => (
            ...
            <Card className="glass-card hover-glow">
              <CardHeader>
                <CardTitle className="text-md font-medium">Investment Rounds Summary</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div>
                    ...
                    <Progress value={32} className="bg-muted h-2" />
                  </div>
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      <div className="text-sm font-medium">Grocery Expansion</div>
                      <div className="text-sm font-medium">$300,000</div>
                    </div>
                    <Progress value={28} className="bg-muted h-2" />
                  </div>
                  <div>
                    <div className="flex items-center justify-between mb-1">
                    ...
                    <Progress value={17} className="bg-muted h-2" />
                  </div>
                  <div>
                    <div className="flex items-center justify-between mb-1">
                    ...
                    <Progress value={23} className="bg-muted h-2" />
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="investors" className="space-y-6">
            ...
            <Card className="glass-card hover-glow">
              <CardHeader>
                <CardTitle className="text-md font-medium">Investor Directory</CardTitle>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
                  ...
                  <TableBody>
                    {investorDetails.filter(inv => inv.id !== "6").map((investor) => (
                      <TableRow key={investor.id}>
                        <TableCell className="font-medium">{investor.name}</TableCell>
                        <TableCell>{investor.type}</TableCell>
                        <TableCell>{investor.percentOwnership}%</TableCell>
                        <TableCell>${investor.investmentTotal.toLocaleString()}</TableCell>
                        <TableCell>{investor.boardSeat ? "Yes" : "No"}</TableCell>
              ...
              {investorDetails.filter(inv => inv.id !== "6").map((investor) => (
                <Card key={investor.id} className="glass-card hover-glow">
                  <CardHeader className="pb-2">
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-lg font-medium">{investor.name}</CardTitle>
                      <Badge variant={investor.boardSeat ? "default" : "outline"}>
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <p className="font-medium">{investor.sharesOwned.toLocaleString()}</p>
                        </div>
                        <div>
                          <p className="text-sm text-muted-foreground">Ownership</p>
                          <p className="font-medium">{investor.percentOwnership}%</p>
                        </div>
                        <div>
                          <p className="text-sm text-muted-foreground">Total Investment</p>
                          <p className="font-medium">${investor.investmentTotal.toLocaleString()}</p>
                        </div>
                        <div>
                          <p className="text-sm text-muted-foreground">Portfolio Companies</p>
                          <p className="font-medium">{investor.portfolioCompanies}</p>
                        </div>
                      </div>
                      <div>
                        <p className="text-sm text-muted-foreground">Representative</p>
                        <p className="font-medium">{investor.representative}</p>
                      </div>
                      <div>
          ...
          <TabsContent value="rounds" className="space-y-6">
            ...
            <Card className="glass-card hover-glow">
              <CardHeader>
                <CardTitle className="text-md font-medium">Funding Rounds Details</CardTitle>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      <TableCell className="font-medium">Grocery Expansion</TableCell>
                    ...
                    <TableRow>
                      <TableCell className="font-medium">Store Network</TableCell>
                    ...
                    <TableRow>
                      <TableCell className="font-medium">Series B (Planned)</TableCell>
            ...
            <Card className="glass-card hover-glow">
              <CardHeader>
                <CardTitle className="text-md font-medium">Funding Milestones & Goals</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                  <div className="space-y-2">
                    <h3 className="text-lg font-medium">Series A (Completed)</h3>
                    <p className="text-muted-foreground">Initial funding to establish the first two store locations and core operations.</p>
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg font-medium">Grocery Expansion (Completed)</h3>
                    <p className="text-muted-foreground">Funding for expanding product lines and opening two additional locations.</p>
                    <div className="flex items-center gap-4 mt-2">
                      <Badge variant="success">Completed</Badge>
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg font-medium">Store Network (Completed)</h3>
                    <p className="text-muted-foreground">Capital for establishing regional presence with three more stores.</p>
                    <div className="flex items-center gap-4 mt-2">
                      <Badge variant="success">Completed</Badge>
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg font-medium">Series B (Planned)</h3>
                    <p className="text-muted-foreground">Strategic growth funding for technology infrastructure, supply chain optimization, and metropolitan market entry.</p>
                    <div className="flex items-center gap-4 mt-2">
          ...
          <TabsContent value="shares" className="space-y-6">
            ...
            <Card className="glass-card hover-glow">
              <CardHeader>
                <CardTitle className="text-md font-medium">Share Distribution Table</CardTitle>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
                  ...
                  <TableBody>
                    {investorDetails.map((investor) => (
                      <TableRow key={investor.id}>
                        <TableCell className="font-medium">{investor.name}</TableCell>
                        <TableCell className="text-right">{investor.sharesOwned.toLocaleString()}</TableCell>
                        <TableCell className="text-right">{investor.percentOwnership}%</TableCell>
                        <TableCell className="text-right">
                          ${(investor.sharesOwned * fundingSummary.currentSharePrice).toLocaleString()}
                        </TableCell>
                        <TableCell>{investor.type}</TableCell>
                      </TableRow>
                    ))}
                    <TableRow>
                      ...
                      <TableCell className="text-right">{fundingSummary.totalShares.toLocaleString()}</TableCell>
                      <TableCell className="text-right">100%</TableCell>
                      <TableCell className="text-right">
                        ${(fundingSummary.totalShares * fundingSummary.currentSharePrice).toLocaleString()}
                      </TableCell>
                      <TableCell>-</TableCell>
                    </TableRow>
                  </TableBody>
            ...
            <Card className="glass-card hover-glow">
              <CardHeader>
                <CardTitle className="text-md font-medium">Share Issuance History</CardTitle>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="text-right font-medium">{fundingSummary.totalShares.toLocaleString()}</TableCell>
                      <TableCell className="text-right">-</TableCell>
                      <TableCell className="text-right font-medium">${(fundingSummary.totalInvestment + 225000).toLocaleString()}</TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </CardContent>
          ...
          <TabsContent value="allocation" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <StatsCard
                ...
                icon={<TrendingUp size={20} />}
                change={{ value: `${fundingSummary.runway} runway`, positive: true }}
              />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card className="glass-card hover-glow">
                <CardHeader>
                  <CardTitle className="text-md font-medium">Capital Allocation Breakdown</CardTitle>
                </CardHeader>
                <CardContent>
                  <Table>
                    <TableHeader>
                    ...
                    <TableBody>
                      {chartData.capitalAllocation.map((item) => (
                        <TableRow key={item.name}>
                          ...
                          <TableCell className="text-right">
                            {(item.value / chartData.capitalAllocation.reduce((sum, i) => sum + i.value, 0) * 100).toFixed(1)}%
                          </TableCell>
                        </TableRow>
                      ))}
                      <TableRow>
                        ...
                        <TableCell className="text-right font-medium">
                          ${chartData.capitalAllocation.reduce((sum, item) => sum + item.value, 0).toLocaleString()}
                        </TableCell>
              ...
              <Card className="glass-card hover-glow">
                <CardHeader>
                  <CardTitle className="text-md font-medium">Capital Allocation Distribution</CardTitle>
                </CardHeader>
                <CardContent className="flex justify-center">
                  <div style={{ height: 300, width: '100%' }}>
                    <ResponsiveContainer width="100%" height="100%">
                      <PieChart>
                        <Pie
                          ...
                          label={({ name, percent }) => `${name} ${(percent * 100).toFixed(1)}%`}
                        >
                          {chartData.capitalAllocation.map((entry, index) => (
                            <Cell key={`cell-${index}`} fill={COLORS[index % COLORS.length]} />
                          ))}
                        </Pie>
            ...
            <Card className="glass-card hover-glow">
              <CardHeader>
                <CardTitle className="text-md font-medium">Investment Performance Metrics</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Annual projected</p>
                    </div>
                    <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      <p className="text-sm text-muted-foreground">Capital Efficiency Ratio</p>
                      <p className="text-2xl font-semibold">1.8x</p>
                      <p className="text-sm text-muted-foreground">Revenue / Capital</p>
                    </div>
                  </div>
                </div>
              </CardContent>
